...
Object.assign(dict.en, {
  ...
  "nlProblemNav": "The Problem",
  "nlFeaturesNav": "Features",
  "nlFinanceNav": "Finance Engine",
  "nlProblemTitle": "The Problem",
  "nlProblemText": "You are running your life on disjointed to-do lists, leading to scattered focus and burnout.",
  "nlAgitationTitle": "The Cost",
  "nlAgitationText": "Every day you lose momentum. Important goals are overshadowed by trivial tasks.",
  "nlSolutionTitle": "The Solution",
  "nlSolutionText": "THE NORTH provides cognitive clarity and protected deep work, translating vision into visible velocity.",
  "nlBentoTitle": "The 4-Pillar Operating System",
  "nlFinanceTitle": "The Finance Engine",
  "nlFinanceBody": "Take full control of your income streams, budget percentage allocations, and capital expenditures to support your strategic goals.",
  "tierProFinance": "✓ Advanced Finance Engine to allocate capital",
...
Object.assign(dict.ar, {
  ...
  "nlProblemNav": "المشكلة",
  "nlFeaturesNav": "المميزات",
  "nlFinanceNav": "محرك المال",
  "nlProblemTitle": "المشكلة",
  "nlProblemText": "أنت تدير حياتك بقوائم مهام مفككة، مما يؤدي إلى تشتت التركيز والإرهاق.",
  "nlAgitationTitle": "التكلفة",
  "nlAgitationText": "كل يوم تفقد الزخم. تطغى المهام التافهة على الأهداف المهمة.",
  "nlSolutionTitle": "الحل",
  "nlSolutionText": "يوفر لك THE NORTH الوضوح الإدراكي والعمل العميق المحمي، ليترجم الرؤية إلى سرعة مرئية.",
  "nlBentoTitle": "نظام التشغيل ذو الأربع ركائز",
  "nlFinanceTitle": "محرك المال",
  "nlFinanceBody": "تحكم في مصادر دخلك، وتخصيصات ميزانيتك، ونفقاتك الرأسمالية لدعم أهدافك الاستراتيجية.",
  "tierProFinance": "✓ محرك مالي متقدم لتخصيص رأس المال",
